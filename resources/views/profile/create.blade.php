...
<div class="flex items-center justify-center h-screen">
    <form action="/profile/store" method="POST" class="w-4/12 bg-white shadow-md rounded-lg p-8">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="name" id="name" placeholder="Fian" class="px-4 py-2 border rounded-lg w-full focus:outline-none focus:border-blue-500">
        </div>
        <div class="mb-4">
            <label for="date" class="block text-gray-700 font-bold mb-2">Tanggal Lahir:</label>
            <input type="date" name="date" id="date" value="{{ date('Y-m-d') }}" class="px-4 py-2 border rounded-lg w-full focus:outline-none focus:border-blue-500">
        </div>
        <div class="mb-4">
            <label for="role" class="block text-gray-700 font-bold mb-2">Jabatan:</label>
            <input type="text" name="role" id="role" placeholder="Manajer" class="px-4 py-2 border rounded-lg w-full focus:outline-none focus:border-blue-500">
        </div>
        <div class="mb-4">
